    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('auction', models.CharField(help_text='Аукционная стоймость товара.', max_length=10, verbose_name='auction')),
                ...
                ('status', models.BooleanField(default=0, help_text='Продаётся/Не продаётся')),
            ],
        ),
        migrations.CreateModel(
            name='Sells',
            fields=[
                ...
                ('auction', models.CharField(help_text='Аукционная стоймость товара.', max_length=10, verbose_name='auction')),
                ('image', models.FileField(help_text='Изображение товара', upload_to='', verbose_name='image')),
                ('status', models.BooleanField(default=0, help_text='Статус заказа')),
            ],
        ),
        migrations.CreateModel(
            name='User',
            fields=[
                ...
                ('balance', models.CharField(default=0, help_text='Баланс', max_length=10, verbose_name='money')),
